...
public class ExampleGui extends GuiScreen {
	...
	public void initGui() {
		...
		rabbit.func_175529_r(3);

		mc.getRenderManager().func_180597_a(world, mc.fontRendererObj, player, player, mc.gameSettings, 0.0F);
	...
	public void drawScreen(int mouseX2, int mouseY2, float partialTicks) {
		...
		if (mc.getRenderManager().worldObj == null || mc.getRenderManager().field_178637_m == null) {
			mc.getRenderManager().func_180597_a(world, mc.fontRendererObj, player, player, mc.gameSettings, 0.0F);
		}
